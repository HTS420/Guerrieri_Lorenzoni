...
from HARK.distribution import Lognormal, MeanOneLogNormal, Uniform, DiscreteDistribution, addDiscreteOutcomeConstantMean, combineIndepDstns
...
class GLSolver(ConsIndShockSolver):
    ...
    def __init__(
        ...
        self.assignParameters(
            ...
            TranShkDstn_list=TranShkDstn_list,
...
#note later we will need interpolate between bonds and labor
        ...
        solution = self.makeSolutionGL(cNrm, mNrm)
        return solution
    ...
    def getPointsForInterpolationGL(self, EndOfPrdvP, aNrmNow):
        ...
        nNow = np.maximum(1-fac*cNrmNow**(self.CRRA/self.eta),0)
        #bNow = self.Bgrid_rep/(self.Rfree) + cNrmNow - thetaMat.dot(nNow) - z
        
        bNow = self.Bgrid_rep/(self.Rfree) + cNrmNow - self.theta*nNow - z
    ...
    def prepareToCalcEndOfPrdvP(self):
        ...
        #TranShkPrbs = self.TranShkDstn_list[0][0].pmf
        #TranShkVals = self.TranShkDstn_list[0][0].X
        ...
        #bNrmGrid = self.aXtraGrid  # Next period's bank balances before labor income
        ...
        # aNrmNext = (aNrm_temp+TranShkVals_temp*nNow-cNrmNow-z)/(self.Rfree)
...
class MarkovConsumerType(IndShockConsumerType):
    ...
    def constructLognormalIncomeProcessUnemployment(self):
        ...
        self.theta = theta
        i0 = DiscreteDistribution(self.MrkvArray[0][0,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i1 = DiscreteDistribution(self.MrkvArray[0][1,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i2 = DiscreteDistribution(self.MrkvArray[0][2,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i3 = DiscreteDistribution(self.MrkvArray[0][3,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i4 = DiscreteDistribution(self.MrkvArray[0][4,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i5 = DiscreteDistribution(self.MrkvArray[0][5,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i6 = DiscreteDistribution(self.MrkvArray[0][6,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i7 = DiscreteDistribution(self.MrkvArray[0][7,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i8 = DiscreteDistribution(self.MrkvArray[0][8,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i9 = DiscreteDistribution(self.MrkvArray[0][9,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i10 = DiscreteDistribution(self.MrkvArray[0][10,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i11 = DiscreteDistribution(self.MrkvArray[0][11,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        i12 = DiscreteDistribution(self.MrkvArray[0][12,:],[np.array([1.0,theta[0]]),np.array([1.0,theta[1]]),np.array([1.0,theta[2]]),np.array([1.0,theta[3]]),np.array([1.0,theta[4]]),np.array([1.0,theta[5]]),np.array([1.0,theta[6]]),np.array([1.0,theta[7]]),np.array([1.0,theta[8]]),np.array([1.0,theta[9]]),np.array([1.0,theta[10]]),np.array([1.0,theta[11]]),np.array([1.0,theta[12]])]) # Income distribution when unemployed
        ...
        for t in range(T_cycle):  # Iterate over all periods, counting forward
            ...
            if T_retire > 0 and t >= T_retire:
                ...
                TranShkDstn_t = combineIndepDstns(i0,i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12)
                        #TranShkDstn_t,
                        #seed=self.RNG.randint(0, 2 ** 31 - 1),
                    #)
                ...
                PermShkDstn_t = MeanOneLogNormal(sigma=PermShkStd[t]).approx(PermShkCount, tail_N=0)
                ### REPLACE
                ###REPLACE
    ...
    def updateSolutionTerminal(self):
        ...
        cmin= -1  # lower bound on consumption
...
def constructAssetsGrid(parameters):
    ...
    BoroCnstArt = parameters.BoroCnstArt
    ...
    for i in range(200):
        if  Bgrid_uc[0,i] > BoroCnstArt:
            aXtraGrid.append(Bgrid_uc[0,i])
    aXtraGrid = np.array(aXtraGrid)
...
init_consumer_objects = {
    "CRRA": 4.0,
    "Rfree": np.array(13 * [1.00625]),  # Interest factor (same in both states)
    "PermGroFac": [np.array(13 * [1])],  # Unemployment-compensated permanent growth factor
    "BoroCnstArt": -1.6,  # Artificial borrowing constraint
    ...
    "aXtraMin": -2,  # Minimum value of assets above minimum in grid
    "aXtraMax": 50,  # Maximum value of assets above minimum in grid
    "aXtraCount": 200,  # Number of points in assets grid
    ...
    "LivPrb": [np.ones(13)],  # Survival probability
    ...
    "CubicBool": False,  # Whether to use cubic splines (False --> linear splines)
...
MarkovType.solve()
plotFuncs([MarkovType.solution[0].cFunc[2],MarkovType.solution[0].cFunc[8]], -2, 12)
